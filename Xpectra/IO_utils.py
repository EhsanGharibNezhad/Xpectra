# Module for providing various utility functions and tools to streamline workflows, handle file I/O operations, and manage configurations.
...
class LoadSave:
    ...
    def __init__(self,
        ...
        if __reference_data__:
            self.base_path = os.path.join(__reference_data__,'Xpectra_reference_data')
        else:
            __reference_data__ = os.getenv("Xpectra_reference_data")
    ...
    def create_generic_path(self, output_indicator):
        ...
        """
        file_name = f'{self.absorber_name}__' \
                    f'{self.experiment_identifier}'
